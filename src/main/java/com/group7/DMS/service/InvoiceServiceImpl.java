...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    public Invoices createInvoiceForContract(int contractId, String invoiceNumber, LocalDate issueDate,
        ...
        if (contract.getRoom() != null && contract.getRoom().getPricePerYear() != null 
            ...
            roomFee = contract.getRoom().getPricePerYear().divide(new BigDecimal(12), 0, java.math.RoundingMode.CEILING);
        }
        invoice.setRoomFee(roomFee);
    ...
    public Payments processPayment(int invoiceId, BigDecimal amount, Payments.PaymentMethod method, String transactionId) {
        ...
        if (transactionId != null && !transactionId.trim().isEmpty()) {
            ...
            boolean duplicateTransaction = existingPayments.stream()
                    .anyMatch(p -> transactionId.equals(p.getTransactionId()) &&
                            p.getStatus() == Payments.PaymentStatus.SUCCESS);
