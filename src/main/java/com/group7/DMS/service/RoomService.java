...
public interface RoomService {
    ...
    Optional<Rooms> findRoomById(int id); // Dùng int vì ID trong entity Buildings/Rooms là int
    List<Rooms> findAllRooms();
    void deleteRoom(int id);

    // Nghiệp vụ (Sử dụng các phương thức từ Repository)
    ...
    // Logic nghiệp vụ phức tạp hơn (Ví dụ: Cập nhật tình trạng chỗ ở)
